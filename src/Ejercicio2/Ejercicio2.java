...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
       claseServicio main = new claseServicio();
       Revolver a;
       
       a=main.llenarRevolver() ;//para mostrar con toString
       System.out.println(main.mojar(a)); //para msotrar el metodo mojar
        
       main.siguienteChorro(a);
